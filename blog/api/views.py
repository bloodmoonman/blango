...
class PostViewSet(viewsets.ModelViewSet):
    ...
    ordering_fields = ["published_at", "author", "title", "slug"] #The fields that can be ordered on can be customized by using the ordering_fields attribute on a view/viewset. Without this line ordering would be possible for all of the fields
